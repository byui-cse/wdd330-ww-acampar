...
export default class DetalhesProduto {
  ...
  async inicializar() {
    // use a fonte de dados para obter os detalhes do produto atual. buscarProdutoPorId retornará uma promessa! use await ou .then() para processá-la
...
// ************* Método Alternativo de Exibição dos Detalhes do Produto *******************
// function modeloDetalhesProduto(produto) {
...
//     </p>
//     <div class="detalhe-produto__add">
